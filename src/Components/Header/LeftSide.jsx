...
const LeftSide = () => {
    ...
    return (
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "810px" }}>
            <img id={"logo"} onClick={() => navigate("/")} src="https://new.parkcinema.az/images/logo.svg" alt="Logo" />
            <List id={"menu"} sx={{ display: "flex", flexDirection: "row", alignItems: "center", gap: 2 }}>
