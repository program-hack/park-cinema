    ...
    return (
        <>
            ...
            <Box sx={{ maxWidth: "600px", mx: "auto", mt: 3 }}>
                ...
                <Typography sx={{ display: "flex", justifyContent: "center", alignItems: "center", color: "#fff", gap: 1, mt: 2.3 }}>Новичок здесь? <Link onClick={() => setRegisterBtn(true)} style={{ color: "#fff" }}>Регистрация</Link></Typography>
            </Box>
        </>
    )
}
